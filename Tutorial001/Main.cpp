#define _CRT_SECURE_NO_WARNINGS // Избегала ошибок
...
int main() {
    ...
    // Здесь 5 пикселей широкой красной линии начинаются с [0,0] до [1000,1000]
    HPEN Line2 = CreatePen(PS_SOLID, 5, RGB(100, 100, 100)); // Цвет задается в RGB

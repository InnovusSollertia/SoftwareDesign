...
HD_PWD='D:/Projects/SoftwareDesign/fpga/ADCtoDACRLPsystem/ADCtoDACRLPsystem.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log radar_processing_tb.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source radar_processing_tb.tcl
